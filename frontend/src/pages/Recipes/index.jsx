    ...
    return(
        <div className="recipes-container jockey-one-regular">
            ...
            <div className="recipe-post-container">
                ...
                <div className="tags-section jockey-one-regular">
                    <h3>Tags:</h3>
                    <div className="tags">
                        <button className="tag vegetarian jockey-one-regular">Vegetarian</button>
                        <button className="tag high-protein jockey-one-regular">High Protein</button>
                        <button className="tag quick jockey-one-regular">{"< 15 minutes"}</button>
                    </div>
                </div>
